...
def save_step_file(shape, filename=None):
    """
    Save a shape to STEP file format.
    If filename is provided, saves to file. Otherwise returns the STEP content as string.
    """
    try:
        if filename is None:
            # Create temporary file to get content
